...
export const RECORD_TEMPLATES = [
  {
    ...
    textSlots: [
      rect(51.84, 18.75, 38.19, 19),
      rect(9.97, 44.9, 38.19, 22.85),
      rect(51.84, 74.9, 38.19, 19),
    ],
  },
  {
    ...
    textSlots: [
      rect(9.97, 18.75, 38.19, 19),
      rect(51.84, 45, 38.19, 22.85),
      rect(9.97, 75.05, 38.19, 19.05),
    ],
  },
  {
